...
describe('YT DLP subtitle service', () => {
  ...
  describe('getAvailableSubtitles', () => {
    ...
    it('should parse and return available uploaded subtitles', async () => {
...
fr       French                  vtt, srt`
    ...
    it('should parse and return available automatic captions', async () => {
      const output = `[info] Available automatic captions for Iu3PTpOzaAM:
Language Name                  Formats
