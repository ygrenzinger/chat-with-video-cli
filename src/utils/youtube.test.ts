...
describe('isValidYouTubeUrl', () => {
  ...
  it('should return true for YouTube URLs with additional parameters', () => {
    ...
    expect(isValidYouTubeUrl('https://youtube.com/watch?v=dQw4w9WgXcQ&list=PLxyz')).toBe(true);
    expect(isValidYouTubeUrl('https://www.youtube.com/watch?v=dQw4w9WgXcQ&ab_channel=test')).toBe(true);
  });

  it('should return true for YouTube URLs with underscores and hyphens in video ID', () => {
    expect(isValidYouTubeUrl('https://www.youtube.com/watch?v=dQ_w4-w9WgX-Q')).toBe(true);
  ...
  it('should return false for YouTube URLs with invalid characters', () => {
    expect(isValidYouTubeUrl('https://youtube.com/watch?v=invalid@id')).toBe(false);
